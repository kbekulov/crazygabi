...
function createLevelTwo() {
  const { rows, put, run } = createLevelRows(46);
  ...
  [
    ...
    [18, 96, 31],
    [15, 120, 26]
  ].forEach(([row, start, length]) => run(row, start, length));
  ...
  for (let row = 19; row <= 30; row += 1) run(row, 58, 2, "w");
  for (let row = 27; row <= 38; row += 1) run(row, 78, 2, "w");
  for (let row = 20; row <= 31; row += 1) run(row, 136, 2, "w");
  for (let row = 37; row <= 44; row += 1) run(row, 118, 2, "w");
