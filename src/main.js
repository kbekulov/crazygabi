...
const ASSET_VERSION = "20260615-bu-crown-fine-tune";
...
class PlayScene extends Phaser.Scene {
  ...
  posePngColossus() {
    ...
    set(parts.crown, {
      x: parts.head.x + 17 + Math.sin(phase + 0.55) * 1.2,
      y: parts.head.y - 102 + crownSlipAmount * 18,
