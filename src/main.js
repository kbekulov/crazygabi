...
function createLevelTwo() {
  ...
  for (let row = 19; row <= 41; row += 1) run(row, 53, 3, "w");
  for (let row = 20; row <= 34; row += 1) run(row, 83, 3, "w");
  for (let row = 25; row <= 42; row += 1) run(row, 101, 3, "w");
  for (let row = 14; row <= 31; row += 1) run(row, 134, 3, "w");
